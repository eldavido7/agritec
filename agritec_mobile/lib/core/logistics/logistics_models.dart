...
class LogisticsMetadata {
  const LogisticsMetadata({required this.salesUnit, required this.unitWeightKg, required this.unitLengthCm, required this.unitWidthCm, required this.unitHeightCm, required this.packageType});
  ...
  double volumetricWeightKg(double divisor) => (unitLengthCm * unitWidthCm * unitHeightCm) / divisor;
  ...
  Map<String, dynamic> toJson() => {'salesUnit': salesUnit.apiValue, 'unitWeightKg': unitWeightKg, 'unitLengthCm': unitLengthCm, 'unitWidthCm': unitWidthCm, 'unitHeightCm': unitHeightCm, 'packageType': packageType.apiValue};
  factory LogisticsMetadata.fromJson(Map<String, dynamic> json) => LogisticsMetadata(
        ...
        unitLengthCm: (json['unitLengthCm'] as num?)?.toDouble() ?? 10,
        unitWidthCm: (json['unitWidthCm'] as num?)?.toDouble() ?? 10,
        unitHeightCm: (json['unitHeightCm'] as num?)?.toDouble() ?? 10,
