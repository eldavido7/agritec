            ...
            <div className="border-t border-border/50 bg-background p-4">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <Button
                  ...
                  disabled={isUploadingAttachment || isSending || pendingAttachments.length >= 10}
                  className="gap-2"
                >
                ...
                <Button
                  ...
                  className="gap-2"
                  disabled={isSending || isUploadingAttachment || (!messageInput.trim() && pendingAttachments.length === 0)}
                >
